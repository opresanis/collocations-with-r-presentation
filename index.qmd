...
- not necessarily expected that one then programs their own code to calculate association measures
- more to understand the algorithmic approach when implementing AMs 
- and to reflect on the various variables and decision points from raw text to measure
- hope this also helps to understand why some apparently identical procedures may yield different outcomes
...
Reproducibility: @Soenning2021, @Schweinberger2026, 
...
::: {.fragment fragment-index=2}
(2) one _parameter_, decided by the researcher
:::
...
There are many other introductions to be considered, for example Bodo Winter @Winter2019. He gives an introduction based on the `tydiverse` dialect of R (other than Gries, who sticks to `base R`) before diving into linear models and inferrential statistics. Slightly earlier work of Guillaume Desagulier @Desagulier2017 but likewise a good introduction to the topic.  

:::

## Measures Discussed in this Presentation


::: {.columns style="font-size: 0.6em;"}

::: {.column width="33%"}
_**Evert's MU**_ (@evert2004phd)

$MU = \frac{O_{11}}{E_{11}}$

\

_**(pointwise) Mutual Information**_
...
$LogRatio = \log_{2} \frac{O_{11} \times R_1}{O_{21} \times R_2}$
